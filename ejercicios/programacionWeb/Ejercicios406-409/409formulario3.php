...
<head>
    ...
    <style>
        ...
        .aficiones { padding-left: 20px; }
        .btn {
            display: inline-block; margin-top: 20px; padding: 10px 20px; background: #3498db; color: white;
            text-decoration: none; border-radius: 5px; font-weight: bold;
        }
        .btn:hover { background: #2980b9; }
        .success { color: #27ae60; font-weight: bold; text-align: center; margin: 20px 0; }
    </style>
</head>
<body>
<div class="container">
    ...
    <table>
        ...
        <tr><td>Apellidos</td><td><?= $datos['apellidos'] ?></td></tr>
        <tr><td>Email</td><td><?= $datos['email'] ?></td></tr>
        <tr><td>URL</td><td><a href="<?= $datos['url'] ?>" target="_blank"><?= $datos['url'] ?></a></td></tr>
        <tr><td>Sexo</td><td><?= ucfirst($datos['sexo']) ?></td></tr>
        <tr><td>Convivientes</td><td><?= $datos['convivientes'] ?></td></tr>
        ...
        <tr><td>Menú favorito</td><td><?= ucfirst($datos['menu']) ?></td></tr>
    </table>
